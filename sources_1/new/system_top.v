...
module system_top #(
    ...
    // These ports come from design_1_wrapper.
    // =========================
    ...
    // ps_fclk_resetn is exported by the Block Design for future extension.
    // Current ADC and BRAM writer logic relies on configuration-time initial
    // values and PS software control bits, so it is intentionally unused here.
    wire unused_ps_fclk_resetn = ps_fclk_resetn;
